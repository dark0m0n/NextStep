...
std::string Token::generateToken(const std::string &username) {
...
std::optional<jwt::decoded_jwt<jwt::traits::kazuho_picojson> > Token::decodeToken(const std::string &token) {
    try {
